...
setup(
	...
	data_files = [
		...
		('/etc/rpm2swidtag/rpm2swidtag.conf.d', ['rpm2swidtag.conf.d/fedora-rawhide.conf', 'rpm2swidtag.conf.d/fedora-31.conf', 'rpm2swidtag.conf.d/fedora-30.conf', 'rpm2swidtag.conf.d/fedora-29.conf']),
		('/etc/swid', ['swidq.conf']),
		('/etc/swid/swidtags.d', []),
