...
bin/rpm2swidtag -p tmp/x86_64/pkg1-1.2.0-1.fc28.x86_64.rpm --software-creator-from tests/swiddata1/a.test/distro.swidtag | normalize > tmp/pkg-generated.swidtag
